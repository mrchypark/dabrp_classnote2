...
[The Grammar of Graphics](http://www.springer.com/us/book/9780387245447)를 따르는 방식으로 차트를 출력물 수준으로 만들 수 있게 보조해주는 패키지. 패키지의 작성 방식은 [여기](http://vita.had.co.nz/papers/layered-grammar.pdf)를 참고하세요.
...
사람은 70~80%의 감각을 시각에 의존하기 때문에 그 어떤 것보다 시각적인 정보를 예민하게 받아 들입니다. 그렇기 때문에 `summary`나 `str` 같은 데이터를 파악하는 함수 보다 차트를 그려봄으로써 얻을 수 있는 정보가 매우 많습니다.
